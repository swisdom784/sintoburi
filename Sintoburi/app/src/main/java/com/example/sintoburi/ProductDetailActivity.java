...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton jjimButton = findViewById(R.id.jjim_button);
        ...
        jjimButton.setOnClickListener(v -> {
            // 찜 처리 로직을 여기에 추가하세요.
            Toast.makeText(ProductDetailActivity.this, "찜에 추가되었습니다.", Toast.LENGTH_SHORT).show();
        });
    }
}
